...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.hbspider.cn"];
pub const RS_PUB_KEY: &str = "C3SQejCZTUvfDzLvvYPBR+k1TwCABFQ1AqFywSG1TN0=";
...
impl PeerConfig {
    ...
    fn default_options() -> HashMap<String, String> {
        ...
        // 设置默认中继服务器
        mp.insert(keys::OPTION_RELAY_SERVER.to_owned(), "rustdesk.hbspider.cn:21117".to_owned());
        // 设置默认密钥
        mp.insert(keys::OPTION_KEY.to_owned(), "C3SQejCZTUvfDzLvvYPBR+k1TwCABFQ1AqFywSG1TN0=".to_owned());
        let _ = [
