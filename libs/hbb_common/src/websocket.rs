...
mod tests {
    ...
    fn test_check_ws() {
        ...
        Config::set_option(
            ...
            "https://rustdesk.hbspider.cn:4433".to_string(),
        );
        assert_eq!(
        ...
        assert_eq!(check_ws("rustdesk.hbspider.cn:21115"), "wss://rustdesk.hbspider.cn/ws/id");
        assert_eq!(check_ws("rustdesk.hbspider.cn:21116"), "wss://rustdesk.hbspider.cn/ws/id");
        assert_eq!(
            check_ws("rustdesk.hbspider.cn:21117"),
            "wss://rustdesk.hbspider.cn/ws/relay"
        );
        ...
        assert_eq!(check_ws("rustdesk.hbspider.cn:21116"), "wss://rustdesk.hbspider.cn/ws/id");
        assert_eq!(
            check_ws("rustdesk.hbspider.cn:34567"),
            "wss://rustdesk.hbspider.cn/ws/relay"
        );
